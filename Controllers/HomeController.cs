...
public class NewBaseType
{
    ...
    public NewBaseType(ILogger<HomeController> logger)
    {
        _logger = logger;
    }
...
{
    public static string? TraceIdentifier { get; internal set; }
}
...
public class HomeController : Controller
{
    ...
    public ILogger<HomeController> ILogger { get; private set; }
